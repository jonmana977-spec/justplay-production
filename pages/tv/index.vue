<template>
    <div class="container-fluid px-3 px-lg-5">
        <div class="mb-5">
            <h1 class="text-light">{{ $t('Tv Shows for you') }}</h1>
        </div>
...
export default {
  head() {
    return {
      title: this.$i18n.t('Tv Shows for you')+' - '+this.$i18n.t('Stream Free Movies & TV Shows'),
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$i18n.t('Tv Shows for you')+' - '+this.$i18n.t('Stream Free Movies & TV Shows')
        }
      ]
    }
  },
    ...
    async fetch() {
        ...
        this.datas = await this.$axios.$get(`discover/tv`, {
            params: this.params
        })
    },
    methods: {
